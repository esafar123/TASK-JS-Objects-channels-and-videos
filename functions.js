...
function getChannelByName(channelName, channels) {
  const getChannel= channels.find((channel)=> channel.name == channelName)
  return getChannel
}
...
function getChannelByVideoTitle(videoTitle, channels) {
 ...
 const getCHbyvido = channels.find( (channel) => channel.videos.some((x)=> x.title ==videoTitle) )
return getCHbyvido

// {
//  const getCHbyvido = channels.find( (channel) => channel.videos == videoTitle)
// return getCHbyvido
// }
...
let x = channels.filter ( channel => channel.name.includes(query) || channel.description.includes(query) ) 
return x
}
